...
public class C206_CaseStudyTest {
	...
	public void testDeleteEvent() {
		...
		C206_CaseStudy.deleteEvent(eventsList, "Family Fun Bike Rally");
		...
		C206_CaseStudy.deleteEvent(eventsList, "Summer Adventure Ride");
	...
	public void testUpdateEvent() {
		...
		C206_CaseStudy.addEvents(eventsList, E1);
		C206_CaseStudy.updateEvent(eventsList, "Summer Adventure Ride");
		
		//error test case
		//given a wrong event name to update the event information it should display event + event name + not found.
		C206_CaseStudy.updateEvent(eventsList, "Night Glow Bike Parade");
